...
-- Module URLs
local moduleUrls = {
    Settings = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/Settings.lua?nocache=" .. tick(),
    Visual = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/Visual.lua?nocache=" .. tick(),
    Teleport = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/Teleport.lua?nocache=" .. tick(),
    Movement = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/Movement.lua?nocache=" .. tick(),
    Player = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/Player.lua?nocache=" .. tick(),
    Utility = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/Utility.lua?nocache=" .. tick(),
    Info = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/Info.lua?nocache=" .. tick(),
    AntiAdmin = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/AntiAdmin.lua?nocache=" .. tick(),
    AntiAdminInfo = "https://raw.githubusercontent.com/FariNoveri/Supertool/main/AntiAdminInfo.lua?nocache=" .. tick()
}
...
local function createTab(name)
    ...
    print("[Supertool] Created tab: " .. name)
...
local function switchCategory(category)
    ...
    if tabs[category] then
        ...
        if modules[category] and modules[category].loadButtons then
            print("[Supertool] Loading buttons for " .. category)
            pcall(function()
...
local function loadModules()
    for name, url in pairs(moduleUrls) do
        print("[Supertool] Attempting to load module: " .. name .. " from " .. url)
        ...
        if success then
            ...
            print("[Supertool] Successfully loaded module: " .. name)
        else
...
local function initialize()
    print("[Supertool] Starting initialization")
    local minimizeButton, logoButton = createGUI()
    print("[Supertool] GUI created, creating tabs")
    for name, _ in pairs(moduleUrls) do
        createTab(name)
    end
    print("[Supertool] Tabs created, loading modules")
    loadModules()
    print("[Supertool] Switching to Settings tab")
