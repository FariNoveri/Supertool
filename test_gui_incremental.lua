...
DebugScreenGui.Position = UDim2.new(0.5, -100, 0.4, -15)
...
DebugMainFrame.Position = UDim2.new(0.5, -100, 0.45, -15)
...
-- Embedded Info watermark
local function loadInfoWatermark()
...
DebugComplete.Position = UDim2.new(0.5, -100, 0.5, -15)
