...
local flyJoystickFrame, flyJoystickKnob, wallClimbButton, flyUpButton, flyDownButton
...
local function refreshReferences()
    ...
    if newRootPart then rootPart = newRootPart end
